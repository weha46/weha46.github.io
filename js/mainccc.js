...
window.addEventListener("DOMContentLoaded", function () {
    ...
    if (listEl) {
        ...
        lastViewed.forEach(item => {
            ...
            li.className = "relative flex flex-row justify-start items-center group gap-x-0 w-full h-32 lg:h-20 bg-cover  overflow-hidden rounded-md bg-gradient-to-br from-white dark:from-gray-900 from-0% via-gray-50 dark:via-gray-925 via-70% to-gray-300 dark:to-gray-925 to-100%";
